...
def send_notifiction():
    ...
    from users.enums import AttendanceStatus
    from users.utils.common import send_email
    ...
    message = send_mail(
        "users Daily Attendance Reminder - " + str(datetime.date.today()),
...
def send_weekly_report():
    from users.models import Booking, CampBooking, Client, Session
    ...
    recipients = ['stephan@usersprojects.com','chin@usersprojects.com', 'chris@usersprojects.com','ethan@usersprojects.com','tony@usersprojects.com','simon@usersprojects.com']

    send_mail(
        "users Weekly Report - " + str(datetime.date.today()),
        "This is a weekly report of client and student activities related to clubs at users for the past 7 days: \n" + \
        "Clients: " + \
...
def send_monthly_report():
    ...
    send_mail(
        "users Monthly Report - " + str(datetime.date.today()),
        "This is a monthly report of client and student activities related to clubs at users for the past 30 days: \n" + \
        "Clients: " + \
        "\nTotal Clients: " + str(total_clients) + \
        "\nTotal Club Clients: " + str(total_club_clients.count()) + \
        "\nAverage Service Rate: " + str(average_service_rate/total_clients) + \

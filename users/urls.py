...
urlpatterns = (
    ...
    # url(r'^admin/club/(?P<id>([a-zA-Z0-9\_\-]+))/badge/$', views.AdminBadgeView.as_view(), name='admin-course-view'),
    ...
    # url(r'^admin/camp/(?P<id>([a-zA-Z0-9\_\-]+))/week/(?P<week_id>([a-zA-Z0-9\_\-]+))/$', views.AdminCampWeekCreateView.as_view(), name='admin-campweek-view'),
    ...
    url(r'^admin/report/$', views.AdminReportView.as_view(), name='admin-report-list'),
    url(r'^admin/report/client$', views.AdminReportClientView.as_view(), name='admin-dashboard-list'),
    url(r'^admin/report/student$', views.AdminReportStudentView.as_view(), name='admin-dashboard-list'),
    url(r'^admin/report/club$', views.AdminReportClubView.as_view(), name='admin-dashboard-list'),
    url(r'^admin/report/camp$', views.AdminReportCampView.as_view(), name='admin-dashboard-list'),

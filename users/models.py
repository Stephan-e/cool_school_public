...
class AbstractUser(AbstractBaseUser, PermissionsMixin):
    ...
    client = models.ForeignKey('users.Client', on_delete = models.CASCADE, related_name="user", blank=True, null=True)
    teacher = models.ForeignKey('users.Teacher', on_delete = models.CASCADE, related_name="user", blank=True, null=True)
    staff = models.ForeignKey('users.Staff', on_delete = models.CASCADE, related_name="user", blank=True, null=True)
...
class Student(DateModel):
    ...
    client = models.ForeignKey('users.Client', on_delete = models.CASCADE, related_name="student")
    ...
    # current_club = models.ForeignKey('users.StudentClub', on_delete = models.CASCADE, blank=True, null=True)
    # location_branch = models.ForeignKey('users.Branch', on_delete = models.CASCADE, related_name="student_branch")
    # student_id_old = models.CharField(max_length=50, db_index=True, blank=True)
    @property
    def age(self):
...
class Client(DateModel):
    ...
    last_name = models.CharField(max_length=50, db_index=True, blank=True)
    location = models.CharField(max_length=50, db_index=True, blank=True)
    # location_branch = models.ForeignKey('users.Branch', on_delete = models.CASCADE, related_name="client_branch")
...
class Payment(DateModel):
    ...
    client = models.ForeignKey('users.Client', on_delete = models.CASCADE, related_name="payment")
...
class StudentClub(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    badges = models.ManyToManyField('users.Badge', blank=True)
    club = models.ForeignKey('users.Club', on_delete = models.CASCADE, related_name="club",null=True,blank=True)
    student = models.ForeignKey('users.Student', on_delete = models.CASCADE, related_name="clubs",null=True,blank=True)
...
class Booking(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    student = models.ForeignKey('users.Student' , related_name="bookings")
    client = models.ForeignKey('users.Client',blank=True, null=True)
    session = models.ForeignKey('users.Session', blank=True, null=True, on_delete = models.CASCADE, related_name="bookings")
    # attendance = models.BooleanField(default=False, blank=True)
...
class CampBooking(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    student = models.ForeignKey('users.Student' , related_name="campbookings")
    client = models.ForeignKey('users.Client',blank=True, null=True)
    session = models.ForeignKey('users.CampSession', blank=True, null=True, on_delete = models.CASCADE, related_name="campbookings")
    date = models.DateField(blank=True, null=True)
    status = EnumField(
                BookingStatus, 
                max_length=50,
...
class BookingRequest(DateModel):
    ...
    client = models.ForeignKey('users.Client', blank=True, null=True)
    session = models.ForeignKey('users.Session', blank=True, null=True)
    date = models.DateField(blank=True, null=True)
    status = EnumField(
                Booking_Status, 
                max_length=50,
...
class Session(DateModel):
    ...
    teacher = models.ForeignKey('users.Teacher', blank=True, null=True, on_delete = models.CASCADE, related_name="session",default=None)
...
class Trial(DateModel):
    ...
    duration = models.DecimalField(max_digits=5, decimal_places=2)
    student_amount = models.IntegerField(default = 0)
    teacher = models.ForeignKey('users.Teacher', blank=True, on_delete = models.CASCADE, related_name="trial",null=True,default=None)
    student = models.ForeignKey('users.Student', blank=True, null=True, on_delete = models.CASCADE, related_name="trial",default=None)
    date = models.DateTimeField(blank=True, null=True)
    sales_representative = models.ForeignKey('users.Staff', blank=True, on_delete = models.CASCADE, related_name="trial",null=True,default=None)
...
class ClientNote(DateModel):
    ...
    client = models.ForeignKey('users.Client', blank=True,null=True,default=None,on_delete = models.CASCADE, related_name="note")
...
class StudentNote(DateModel):
    ...
    note =  models.CharField(max_length=2000)
    user = models.ForeignKey('users.User', blank=True,null=True)
    student = models.ForeignKey('users.Student', blank=True,null=True,default=None,on_delete = models.CASCADE, related_name="note")
...
class SessionNote(DateModel):
    ...
    note =  models.CharField(max_length=2000)
    user = models.ForeignKey('users.User', blank=True,null=True)
    session = models.ForeignKey('users.Session', blank=True,null=True,default=None,on_delete = models.CASCADE, related_name="note")
...
class CampWeek(DateModel):
    ...
    start_date = models.DateField(blank=True, null=True)
    end_date = models.DateField(blank=True, null=True)
    camp = models.ForeignKey('users.Camp', blank=True, null=True, on_delete = models.CASCADE, related_name="campweek",default=None)
...
class CampSession(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    description = models.CharField(max_length=200, default = None, null=True, blank=True)
    week = models.ForeignKey('users.CampWeek', blank=True, null=True, on_delete = models.CASCADE,default=None)
    location = models.CharField(max_length=100)
    club = models.CharField(max_length=50, db_index=True, blank=True)
    teacher = models.ForeignKey('users.Teacher', blank=True, null=True, on_delete = models.CASCADE, related_name="campsession",default=None)
    status = EnumField(
                SessionStatus, 
                max_length=50,
                default=SessionStatus.ACTIVE)
    ...
    camp = models.ForeignKey('users.Camp', blank=True, null=True, on_delete = models.CASCADE, related_name="campsession",default=None)
    student_amount = models.IntegerField(default = 0)


class Enrollment(DateModel):
    student = models.ForeignKey('users.Student' , related_name="student")
    session = models.ForeignKey('users.Session', blank=True, null=True, on_delete = models.CASCADE, related_name="session")

...
class AbstractUser(AbstractBaseUser, PermissionsMixin):
    ...
    teacher = models.ForeignKey('skyrock.Teacher', on_delete = models.CASCADE, related_name="user", blank=True, null=True)
    staff = models.ForeignKey('skyrock.Staff', on_delete = models.CASCADE, related_name="user", blank=True, null=True)
...
class Student(DateModel):
    ...
    # current_club = models.ForeignKey('skyrock.StudentClub', on_delete = models.CASCADE, blank=True, null=True)
    # location_branch = models.ForeignKey('skyrock.Branch', on_delete = models.CASCADE, related_name="student_branch")
...
class Client(DateModel):
    ...
    last_name = models.CharField(max_length=50, db_index=True, blank=True)
    location = models.CharField(max_length=50, db_index=True, blank=True)
    # location_branch = models.ForeignKey('skyrock.Branch', on_delete = models.CASCADE, related_name="client_branch")
...
class Payment(DateModel):
    ...
    client = models.ForeignKey('skyrock.Client', on_delete = models.CASCADE, related_name="payment")
...
class StudentClub(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    badges = models.ManyToManyField('skyrock.Badge', blank=True)
    club = models.ForeignKey('skyrock.Club', on_delete = models.CASCADE, related_name="club",null=True,blank=True)
    student = models.ForeignKey('skyrock.Student', on_delete = models.CASCADE, related_name="clubs",null=True,blank=True)
...
class Booking(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    student = models.ForeignKey('skyrock.Student' , related_name="bookings")
    client = models.ForeignKey('skyrock.Client',blank=True, null=True)
    session = models.ForeignKey('skyrock.Session', blank=True, null=True, on_delete = models.CASCADE, related_name="bookings")
...
class CampBooking(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    student = models.ForeignKey('skyrock.Student' , related_name="campbookings")
    client = models.ForeignKey('skyrock.Client',blank=True, null=True)
    session = models.ForeignKey('skyrock.CampSession', blank=True, null=True, on_delete = models.CASCADE, related_name="campbookings")
    date = models.DateField(blank=True, null=True)
    status = EnumField(
                BookingStatus, 
                max_length=50,
...
class Session(DateModel):
    ...
    teacher = models.ForeignKey('skyrock.Teacher', blank=True, null=True, on_delete = models.CASCADE, related_name="session",default=None)
    students = models.ManyToManyField('skyrock.Student', blank=True)
...
class Trial(DateModel):
    ...
    duration = models.DecimalField(max_digits=5, decimal_places=2)
    student_amount = models.IntegerField(default = 0)
    teacher = models.ForeignKey('skyrock.Teacher', blank=True, on_delete = models.CASCADE, related_name="trial",null=True,default=None)
    student = models.ForeignKey('skyrock.Student', blank=True, null=True, on_delete = models.CASCADE, related_name="trial",default=None)
    date = models.DateTimeField(blank=True, null=True)
    sales_representative = models.ForeignKey('skyrock.Staff', blank=True, on_delete = models.CASCADE, related_name="trial",null=True,default=None)
...
class ClientNote(DateModel):
    ...
    user = models.ForeignKey('skyrock.User', blank=True,null=True)
    client = models.ForeignKey('skyrock.Client', blank=True,null=True,default=None,on_delete = models.CASCADE, related_name="note")
...
class StudentNote(DateModel):
    ...
    note =  models.CharField(max_length=2000)
    user = models.ForeignKey('skyrock.User', blank=True,null=True)
    student = models.ForeignKey('skyrock.Student', blank=True,null=True,default=None,on_delete = models.CASCADE, related_name="note")
...
class SessionNote(DateModel):
    ...
    note =  models.CharField(max_length=2000)
    user = models.ForeignKey('skyrock.User', blank=True,null=True)
    session = models.ForeignKey('skyrock.Session', blank=True,null=True,default=None,on_delete = models.CASCADE, related_name="note")
...
class CampWeek(DateModel):
    ...
    start_date = models.DateField(blank=True, null=True)
    end_date = models.DateField(blank=True, null=True)
    camp = models.ForeignKey('skyrock.Camp', blank=True, null=True, on_delete = models.CASCADE, related_name="campweek",default=None)
...
class CampSession(DateModel):
    identifier = models.UUIDField(unique=True, db_index=True,
        default=uuid.uuid4)
    description = models.CharField(max_length=200, default = None, null=True, blank=True)
    week = models.ForeignKey('skyrock.CampWeek', blank=True, null=True, on_delete = models.CASCADE,default=None)
    location = models.CharField(max_length=100)
    club = models.CharField(max_length=50, db_index=True, blank=True)
    teacher = models.ForeignKey('skyrock.Teacher', blank=True, null=True, on_delete = models.CASCADE, related_name="campsession",default=None)
    status = EnumField(
                SessionStatus, 
                max_length=50,
                default=SessionStatus.ACTIVE)
    ...
    camp = models.ForeignKey('skyrock.Camp', blank=True, null=True, on_delete = models.CASCADE, related_name="campsession",default=None)
    student_amount = models.IntegerField(default = 0)


class Enrollment(DateModel):
    student = models.ForeignKey('skyrock.Student' , related_name="student")
    session = models.ForeignKey('skyrock.Session', blank=True, null=True, on_delete = models.CASCADE, related_name="session")
